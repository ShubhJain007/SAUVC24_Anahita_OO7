// Generated by gencpp from file anahita_msgs/Thrust.msg
// DO NOT EDIT!


#ifndef ANAHITA_MSGS_MESSAGE_THRUST_H
#define ANAHITA_MSGS_MESSAGE_THRUST_H
...
struct Thrust_
{
  ...
  typedef boost::shared_ptr< ::anahita_msgs::Thrust_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::anahita_msgs::Thrust_<ContainerAllocator> const> ConstPtr;

}; // struct Thrust_

typedef ::anahita_msgs::Thrust_<std::allocator<void> > Thrust;

typedef boost::shared_ptr< ::anahita_msgs::Thrust > ThrustPtr;
typedef boost::shared_ptr< ::anahita_msgs::Thrust const> ThrustConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::anahita_msgs::Thrust_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::anahita_msgs::Thrust_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::anahita_msgs::Thrust_<ContainerAllocator1> & lhs, const ::anahita_msgs::Thrust_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::anahita_msgs::Thrust_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::anahita_msgs::Thrust_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::anahita_msgs::Thrust_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::anahita_msgs::Thrust_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::anahita_msgs::Thrust_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::anahita_msgs::Thrust_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::anahita_msgs::Thrust_<ContainerAllocator> >
{
  ...
  static const char* value(const ::anahita_msgs::Thrust_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x26902eeb89b0dc72ULL;
  static const uint64_t static_value2 = 0x9d9c14f541db9878ULL;
};

template<class ContainerAllocator>
struct DataType< ::anahita_msgs::Thrust_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::anahita_msgs::Thrust_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::anahita_msgs::Thrust_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::anahita_msgs::Thrust_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::anahita_msgs::Thrust_<ContainerAllocator>& v)
  {
...
#endif // ANAHITA_MSGS_MESSAGE_THRUST_H
