...
(cl:defmethod cl:initialize-instance :after ((m <Hold-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hold-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master_layer-srv:<Hold-request> is deprecated: use master_layer-srv:Hold-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Hold-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hold-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master_layer-srv:<Hold-response> is deprecated: use master_layer-srv:Hold-response instead.")))
