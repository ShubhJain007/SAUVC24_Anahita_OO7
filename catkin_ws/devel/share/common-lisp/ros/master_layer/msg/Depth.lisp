...
(cl:defmethod cl:initialize-instance :after ((m <Depth>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Depth)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master_layer-msg:<Depth> is deprecated: use master_layer-msg:Depth instead.")))
...
(cl:defmethod depth-val ((m <Depth>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:depth-val is deprecated.  Use master_layer-msg:depth instead.")
  (depth m))
