...
(cl:defmethod cl:initialize-instance :after ((m <Thrust>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Thrust)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master_layer-msg:<Thrust> is deprecated: use master_layer-msg:Thrust instead.")))

(cl:ensure-generic-function 'sideward_back-val :lambda-list '(m))
(cl:defmethod sideward_back-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:sideward_back-val is deprecated.  Use master_layer-msg:sideward_back instead.")
  (sideward_back m))

(cl:ensure-generic-function 'sideward_front-val :lambda-list '(m))
(cl:defmethod sideward_front-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:sideward_front-val is deprecated.  Use master_layer-msg:sideward_front instead.")
  (sideward_front m))

(cl:ensure-generic-function 'forward_right-val :lambda-list '(m))
(cl:defmethod forward_right-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:forward_right-val is deprecated.  Use master_layer-msg:forward_right instead.")
  (forward_right m))

(cl:ensure-generic-function 'forward_left-val :lambda-list '(m))
(cl:defmethod forward_left-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:forward_left-val is deprecated.  Use master_layer-msg:forward_left instead.")
  (forward_left m))

(cl:ensure-generic-function 'upward_north_east-val :lambda-list '(m))
(cl:defmethod upward_north_east-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:upward_north_east-val is deprecated.  Use master_layer-msg:upward_north_east instead.")
  (upward_north_east m))

(cl:ensure-generic-function 'upward_north_west-val :lambda-list '(m))
(cl:defmethod upward_north_west-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:upward_north_west-val is deprecated.  Use master_layer-msg:upward_north_west instead.")
  (upward_north_west m))

(cl:ensure-generic-function 'upward_south_east-val :lambda-list '(m))
(cl:defmethod upward_south_east-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:upward_south_east-val is deprecated.  Use master_layer-msg:upward_south_east instead.")
  (upward_south_east m))

(cl:ensure-generic-function 'upward_south_west-val :lambda-list '(m))
(cl:defmethod upward_south_west-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:upward_south_west-val is deprecated.  Use master_layer-msg:upward_south_west instead.")
  (upward_south_west m))

(cl:ensure-generic-function 'marker_dropper-val :lambda-list '(m))
(cl:defmethod marker_dropper-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:marker_dropper-val is deprecated.  Use master_layer-msg:marker_dropper instead.")
  (marker_dropper m))

(cl:ensure-generic-function 'torpedo-val :lambda-list '(m))
(cl:defmethod torpedo-val ((m <Thrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_layer-msg:torpedo-val is deprecated.  Use master_layer-msg:torpedo instead.")
  (torpedo m))
