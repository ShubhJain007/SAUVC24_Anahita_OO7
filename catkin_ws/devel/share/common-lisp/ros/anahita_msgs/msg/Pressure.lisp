...
(cl:defmethod cl:initialize-instance :after ((m <Pressure>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pressure)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name anahita_msgs-msg:<Pressure> is deprecated: use anahita_msgs-msg:Pressure instead.")))
...
(cl:defmethod fluid_pressure-val ((m <Pressure>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anahita_msgs-msg:fluid_pressure-val is deprecated.  Use anahita_msgs-msg:fluid_pressure instead.")
  (fluid_pressure m))
