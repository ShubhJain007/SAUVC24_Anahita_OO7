...
(defsystem "uuv_control_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "BottomSearch" :depends-on ("_package_BottomSearch"))
    (:file "_package_BottomSearch" :depends-on ("_package"))
    (:file "CancelRequest" :depends-on ("_package_CancelRequest"))
    (:file "_package_CancelRequest" :depends-on ("_package"))
    (:file "ClearWaypoints" :depends-on ("_package_ClearWaypoints"))
    (:file "_package_ClearWaypoints" :depends-on ("_package"))
    (:file "FrontSearch" :depends-on ("_package_FrontSearch"))
    (:file "_package_FrontSearch" :depends-on ("_package"))
    ...
    (:file "StallVehicle" :depends-on ("_package_StallVehicle"))
    (:file "_package_StallVehicle" :depends-on ("_package"))
