...
let yawPIDGoal = require('./yawPIDGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class yawPIDActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = yawPIDGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new yawPIDActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = yawPIDGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new yawPIDGoal()
    }
...
module.exports = yawPIDActionGoal;
