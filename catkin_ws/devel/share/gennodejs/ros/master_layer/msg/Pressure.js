...
class Pressure {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.fluid_pressure, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.fluid_pressure = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
