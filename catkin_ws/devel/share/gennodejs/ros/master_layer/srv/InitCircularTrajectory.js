...
class InitCircularTrajectoryRequest {
  ...
  static datatype() {
    ...
    return 'master_layer/InitCircularTrajectoryRequest';
  }
...
class InitCircularTrajectoryResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'master_layer/InitCircularTrajectoryResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'master_layer/InitCircularTrajectory'; }
};
