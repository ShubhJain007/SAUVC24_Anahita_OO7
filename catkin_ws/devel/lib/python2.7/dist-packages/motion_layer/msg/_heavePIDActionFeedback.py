...
"""autogenerated by genpy from motion_layer/heavePIDActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class heavePIDActionFeedback(genpy.Message):
  _md5sum = "0ee65a3af34f039a08aeffd8cfd1e378"
  _type = "motion_layer/heavePIDActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motion_layer/heavePIDFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(heavePIDActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = motion_layer.msg.heavePIDFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = motion_layer.msg.heavePIDFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.current_heave
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_heave,) = _get_struct_f().unpack(str[start:end])
      return self
