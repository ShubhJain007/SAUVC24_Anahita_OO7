...
"""autogenerated by genpy from motion_layer/heavePIDActionResult.msg. Do not edit."""
import codecs
import sys
...
class heavePIDActionResult(genpy.Message):
  _md5sum = "6008c58a056fc32d83daf63f525bd435"
  _type = "motion_layer/heavePIDActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','motion_layer/heavePIDResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(heavePIDActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = motion_layer.msg.heavePIDResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = motion_layer.msg.heavePIDResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.final_heave,) = _get_struct_f().unpack(str[start:end])
      return self
