...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "${prefix}/include;/usr/include/gazebo-9/gazebo/msgs;/usr/include/OGRE;/usr/include;/usr/include/OGRE/Paging;/usr/include/opencv;/usr/include/eigen3".split(';') if "${prefix}/include;/usr/include/gazebo-9/gazebo/msgs;/usr/include/OGRE;/usr/include;/usr/include/OGRE/Paging;/usr/include/opencv;/usr/include/eigen3" != "" else []
PROJECT_CATKIN_DEPENDS = "uuv_gazebo_plugins;sensor_msgs;uuv_sensor_ros_plugins_msgs".replace(';', ' ')
